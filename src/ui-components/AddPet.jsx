...
export default function AddPet(props) {
  ...
  const [
    textFieldThreeOneFiveEightTwoSixNineFiveValue,
    setTextFieldThreeOneFiveEightTwoSixNineFiveValue,
  ] = useStateMutationAction("");
  const [
    textFieldThreeOneFiveEightTwoSevenZeroNineValue,
    setTextFieldThreeOneFiveEightTwoSevenZeroNineValue,
  ] = useStateMutationAction("");
  const [
    textFieldThreeOneFiveEightTwoSevenZeroTwoValue,
    setTextFieldThreeOneFiveEightTwoSevenZeroTwoValue,
  ] = useStateMutationAction("");
  const buttonTwoNineSevenSixSixNineTwoSixOnClick = useDataStoreCreateAction({
    fields: {
      ...
      about: textFieldThreeOneFiveEightTwoSixNineFiveValue,
      image: textFieldThreeOneFiveEightTwoSevenZeroNineValue,
      color: textFieldThreeOneFiveEightTwoSevenZeroTwoValue,
    },
    model: Pet,
    schema: schema,
  });
  const buttonThreeOneFiveEightTwoSevenTwoFourOnClick =
    useDataStoreUpdateAction({
      fields: {
        name: textFieldTwoNineSevenSixSixNineTwoTwoValue,
        age: textFieldTwoNineSevenSixSixNineTwoThreeValue,
      ...
      >
        ...
        >
          ...
          <TextField
            ...
            labelHidden={false}
            variation="default"
            value={textFieldThreeOneFiveEightTwoSixNineFiveValue}
            onChange={(event) => {
              setTextFieldThreeOneFiveEightTwoSixNineFiveValue(
                event.target.value
              );
            }}
            {...getOverrideProps(overrides, "TextField31582695")}
          ></TextField>
          <TextField
            display="flex"
            gap="8px"
            ...
            labelHidden={false}
            variation="default"
            value={textFieldThreeOneFiveEightTwoSevenZeroTwoValue}
            onChange={(event) => {
              setTextFieldThreeOneFiveEightTwoSevenZeroTwoValue(
                event.target.value
              );
            }}
            {...getOverrideProps(overrides, "TextField31582702")}
          ></TextField>
          <TextField
            display="flex"
            gap="8px"
            ...
            labelHidden={false}
            variation="default"
            value={textFieldThreeOneFiveEightTwoSevenZeroNineValue}
            onChange={(event) => {
              setTextFieldThreeOneFiveEightTwoSevenZeroNineValue(
                event.target.value
              );
            }}
            {...getOverrideProps(overrides, "TextField31582709")}
          ></TextField>
        </Flex>
        <Divider
          height="1px"
        ...
        >
          ...
          <Button
            ...
            children="Update"
            onClick={() => {
              buttonThreeOneFiveEightTwoSevenTwoFourOnClick();
            }}
            {...getOverrideProps(overrides, "Button31582724")}
          ></Button>
        </Flex>
      </Flex>
    </Flex>
